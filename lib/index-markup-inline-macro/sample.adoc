...
For its meaning, and that of DocBook's `+<indexterm>+` attributes `+type+`, `+significance+`, `+scope+`, and `+pagenum+` (all of which you can use in your list), please see the excellent DocBook text by Norman Walsh--most editions of which you can https://tdg.docbook.org/tdg/4.5/docbook.html[find online]. (Bob Stayton's http://www.sagehill.net/book-description.html[book] _DocBook XSL_, now in its 4th ed., is also invaluable.)
