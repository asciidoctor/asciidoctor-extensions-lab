...
DataAttributeInlineMacro, link:lib/data-attribute-inline-macro.rb[]::
Allow adding HTML https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/data-*[data attributes] to a document
