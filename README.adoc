...
IndexMarkupInlineMacro, link:lib/index-markup-inline-macro.rb[]::
Gives four macros which, taken together, make it possible to write in AsciiDoc any and all DocBook indexing-markup.
